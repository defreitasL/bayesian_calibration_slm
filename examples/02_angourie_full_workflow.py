...
DATA_FILE = HERE / "data" / "Angourie_data.nc"

OUT_DIR = HERE / ".." / "outputs" / "Angourie" / "Y09"
...
NSGA_CFG = FastOptNSGA2Config(
    ...
    pcento=0.001,
    peps=1e-4,
    n_restarts=10,            # increase for real runs (e.g., 30)
    random_seed=42,
)
...
print(az.summary(trace, var_names=['raw_par']))
